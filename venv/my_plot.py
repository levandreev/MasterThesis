...
df.to_csv('results_amazon_pol_allpos_svm1_wstop_1-2gram.csv', index = False, header = True)

plt.errorbar(N, plot_f1, std_error_array, linestyle='None', marker='.')
plt.savefig('amazon_pol_allpos_svm1_wstop_1-2gram_f1.png')
plt.clf()
plt.errorbar(N, plot_accuracy, std_error_array, linestyle='None', marker='.')
plt.savefig('amazon_pol_allpos_svm1_wstop_1-2gram_acc.png')
