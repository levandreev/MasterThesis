...
#     classifier = GaussianNB()
    ...
    y = []
    plot_f1 = []
    with open('preprocessed_dbpedia_100k_nouns.csv', newline='') as csvfile:
...
df.to_csv('results_dbpedia_nouns_svm1_stop_1-2gram.csv', index = False, header = True)

plt.errorbar(N, plot_f1, std_error_array, linestyle='None', marker='.')
plt.savefig('dbpedia_nouns_svm1_stop_1-2gram_f1.png')
plt.clf()
plt.errorbar(N, plot_accuracy, std_error_array, linestyle='None', marker='.')
plt.savefig('dbpedia_nouns_svm1_stop_1-2gram_acc.png')
