...
df.to_csv('results_yelp_pol_nouns_svm1_wstop_unigram.csv', index = False, header = True)

plt.errorbar(N, plot_f1, std_error_array, linestyle='None', marker='.')
plt.savefig('yelp_pol_nouns_svm1_wstop_unigram_f1.png')
plt.clf()
plt.errorbar(N, plot_accuracy, std_error_array, linestyle='None', marker='.')
plt.savefig('yelp_pol_nouns_svm1_wstop_unigram_acc.png')
